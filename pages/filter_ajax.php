...
/**
 * filter_ajax.php
 * AJAX endpoint — returns filtered tea cards using the team's existing card style.
 */
...
$products = getFilteredTeas($pdo, $flavours, $benefits, $caffeine, $origins, $sort, $search);
